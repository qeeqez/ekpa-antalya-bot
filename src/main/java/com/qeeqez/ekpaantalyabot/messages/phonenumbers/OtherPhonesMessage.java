package com.qeeqez.ekpaantalyabot.messages.phonenumbers;

import com.qeeqez.ekpaantalyabot.markup.phonenumbers.OtherPhonesMarkup;
...
@Getter
@Setter
public class OtherPhonesMessage extends EditMessageText {
    ...
    private OtherPhonesMessage(long chatId) {
        this();
        setChatId(String.valueOf(chatId));
    }

    public OtherPhonesMessage(long chatId, long messageId) {
        this(chatId);
