...
public class AddressRegistrationMessage extends EditMessageText {
    ...
    private final String text = """
            *📌 Прописка*
            ...
            ℹ️ Приходить лучше рано, даже к открытию, в очереди можно простоять пол дня\\. Сама прописка занимает 5 минут\\.
            
            💼 *Взять с собой:*
            1\\. Икамет \\(ВНЖ\\)
            2\\. Тапу или договор аренды
            3\\. Нумаратаж \\(Numarataj\\)
            4\\. Квитанцию с оплатой за воду или электричество на свое имя
